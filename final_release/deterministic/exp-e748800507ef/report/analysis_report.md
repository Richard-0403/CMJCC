...
> `_runs/exp-e748800507ef/<variant>/<scenario_id>/<run_index>/` and the tables under `metrics/` and
> `statistics/` inside this directory. The run-bundle tree is a sibling of this analysis
> output directory `exp-e748800507ef/`: both live under the pipeline's `--out-root`.
>
...
- Experiment `exp-e748800507ef` — 42 scenarios ×
...
- Headline (full variant, scenario-mean, with the denominator `n` each mean was taken
  over — they differ between metrics, see §5): NDCG@5 0.911 (n=37), HCSR 0.984 (n=37), Task Success 0.976 (n=42), Grounding 1.000 (n=42), Handoff 1.000 (n=42).
...
|---|---|---|---|---|---|---|---|---|
| full | 0.911 | 0.958 | 0.984 | 0.976 | 1.000 | 1.000 | 1.50 | 19 |
| profile_only | 0.560 | 0.558 | 0.479 | 0.167 | 1.000 | 1.000 | 1.50 | 17 |
| one_shot | 0.917 | 0.962 | 0.962 | 0.595 | 1.000 | 1.000 | 1.33 | 12 |
| no_memory | 0.938 | 0.971 | 0.971 | 0.762 | 1.000 | 1.000 | 1.50 | 17 |
| no_context | 0.719 | 0.684 | 0.624 | 0.167 | 1.000 | 1.000 | 1.50 | 26 |
...
- NDCG@5, full vs profile_only: Δ=+0.353, 95% CI [+0.222, +0.490] (CI excludes 0), n=23 paired scenarios.
- NDCG@5, full vs one_shot: Δ=+0.015, 95% CI [+0.000, +0.040] (CI includes 0), n=21 paired scenarios.
- Task success, full vs profile_only: Δ=+0.810, 95% CI [+0.690, +0.929] (CI excludes 0), n=42 paired scenarios.
- Task success, full vs one_shot: Δ=+0.381, 95% CI [+0.238, +0.524] (CI excludes 0), n=42 paired scenarios.
...
| preferred_locations | 1.000 (n=21) | 0.073 (n=55) | 1.000 (n=19) | 1.000 (n=19) | 0.617 (n=60) |
| salary_min | 1.000 (n=125) | 0.642 (n=120, unk 8%) | 1.000 (n=74) | 1.000 (n=84) | 0.806 (n=165, unk 15%) |
| work_modes | 0.727 (n=11, unk 27%) | 0.167 (n=30, unk 30%) | 0.636 (n=11, unk 27%) | 0.636 (n=11, unk 27%) | 0.500 (n=30, unk 33%) |
...
|---|---|---|---|---|---|---|
| full | ndcg_at_5 | 0.911 | N/A | N/A | 37 | N/A |
| full | precision_at_5 | 0.958 | N/A | N/A | 37 | N/A |
| full | mean_graded_relevance | 2.696 | N/A | N/A | 37 | N/A |
| profile_only | ndcg_at_5 | 0.560 | N/A | N/A | 24 | N/A |
| profile_only | precision_at_5 | 0.558 | N/A | N/A | 24 | N/A |
| profile_only | mean_graded_relevance | 1.625 | N/A | N/A | 24 | N/A |
| one_shot | ndcg_at_5 | 0.917 | N/A | N/A | 21 | N/A |
| one_shot | precision_at_5 | 0.962 | N/A | N/A | 21 | N/A |
| one_shot | mean_graded_relevance | 2.705 | N/A | N/A | 21 | N/A |
| no_memory | ndcg_at_5 | 0.938 | N/A | N/A | 28 | N/A |
| no_memory | precision_at_5 | 0.971 | N/A | N/A | 28 | N/A |
| no_memory | mean_graded_relevance | 2.707 | N/A | N/A | 28 | N/A |
| no_context | ndcg_at_5 | 0.719 | N/A | N/A | 38 | N/A |
| no_context | precision_at_5 | 0.684 | N/A | N/A | 38 | N/A |
| no_context | mean_graded_relevance | 1.984 | N/A | N/A | 38 | N/A |
...
|---|---|---|---|---|---|---|---|---|---|---|
| full | 42 | 198.595 | 50.000 | 0.710 | 0.000 | 6.205 | 0.562 | 0.974 | 0.024 | 0.000 |
| no_context | 42 | 198.595 | 50.000 | 0.710 | 0.000 | 6.501 | 0.562 | 0.974 | 0.024 | 0.024 |
| no_memory | 33 | 198.636 | 50.000 | 0.712 | 0.000 | 6.860 | 0.554 | 0.966 | 0.030 | 0.000 |
| one_shot | 26 | 198.923 | 50.000 | 0.697 | 0.000 | 6.206 | 0.537 | 0.955 | 0.038 | 0.000 |
| profile_only | 28 | 198.750 | 50.000 | 0.694 | 0.000 | 6.550 | 0.552 | 0.958 | 0.036 | 0.179 |
...
|---|---|---|---|---|---|---|
| role_match | 0.278 | 0.891 | 0.248 | 0.340 | 3 | role_exact |
| required_skill_match | 0.278 | 0.605 | 0.170 | 0.233 | 16 | required_skill_coverage |
| location_preference | 0.107 | 0.676 | 0.075 | 0.103 | 55 | location_match |
| salary_preference | 0.081 | 0.606 | 0.065 | 0.089 | 43 | salary_meets_min |
| experience_fit | 0.078 | 0.803 | 0.063 | 0.086 | 14 | experience_in_range |
| preferred_skill_match | 0.111 | 0.526 | 0.058 | 0.080 | 29 | preferred_skill_coverage |
| work_mode_preference | 0.067 | 0.474 | 0.050 | 0.069 | 74 | work_mode_match |
| industry_preference | 0.000 | 0.000 | 0.000 | 0.000 | 170 | industry_not_specified |
...
|---|---|---|---|---|---|---|---|---|
| full | 175 | 1.000 | 0.000 | 0 | 0 | 0 | N/A | N/A |
| no_context | 175 | 1.000 | 0.000 | 0 | 0 | 0 | N/A | N/A |
| no_memory | 135 | 1.000 | 0.000 | 0 | 0 | 0 | N/A | N/A |
| one_shot | 142 | 1.000 | 0.000 | 0 | 0 | 0 | N/A | N/A |
| profile_only | 135 | 1.000 | 0.000 | 0 | 0 | 0 | N/A | N/A |
...
|---|---|---|---|---|---|---|---|---|
| ndcg_at_5 | 0.875 | 0.831 | 0.044 | [0.000, 0.106] | 0.500 | 1.000 | 0.535 (cohens_dz) | 7 |
| hcsr | 0.914 | 0.886 | 0.029 | [0.000, 0.086] | 1.000 | 1.000 | 0.378 (cohens_dz) | 7 |
...
| mean_violation_count | 0.086 | 0.114 | -0.029 | [-0.086, 0.000] | 1.000 | 1.000 | -0.378 (cohens_dz) | 7 |
| turn_count | 1.875 | 1.875 | 0.000 | [0.000, 0.000] | 1.000 | 1.000 | 0.000 (rank_biserial) | 16 |

`task_success` is the **scenario-level binary** (repeats collapsed by majority vote, even-repeat ties → 0) in every column of its row, including the Δ and the CI. For reference, the mean success RATE over repeats is 0.938 (full) vs 0.375 (Δ 0.562); that is a different estimand and is not what the test above was computed on.

All scenarios:

| metric | full | other | Δ | 95% CI | p | p(Holm) | effect | n |
|---|---|---|---|---|---|---|---|---|
| ndcg_at_5 | 0.944 | 0.938 | 0.006 | [-0.012, 0.026] | 0.593 | 1.000 | 0.114 (cohens_dz) | 28 |
| hcsr | 0.979 | 0.971 | 0.007 | [0.000, 0.021] | 0.317 | 1.000 | 0.189 (cohens_dz) | 28 |
| task_success | 0.976 | 0.762 | 0.214 | [0.095, 0.333] | 0.004 | 0.023 | 1.000 (rank_biserial) | 42 |
| grounding | 1.000 | 1.000 | 0.000 | [0.000, 0.000] | 1.000 | 1.000 | 0.000 (rank_biserial) | 33 |
| mean_violation_count | 0.021 | 0.029 | -0.007 | [-0.021, 0.000] | 0.317 | 1.000 | -0.189 (cohens_dz) | 28 |
| turn_count | 1.500 | 1.500 | 0.000 | [0.000, 0.000] | 1.000 | 1.000 | 0.000 (rank_biserial) | 42 |

`task_success` is the **scenario-level binary** (repeats collapsed by majority vote, even-repeat ties → 0) in every column of its row, including the Δ and the CI. For reference, the mean success RATE over repeats is 0.976 (full) vs 0.762 (Δ 0.214); that is a different estimand and is not what the test above was computed on.
...
| metric | full | other | Δ | 95% CI | p | p(Holm) | effect | n |
|---|---|---|---|---|---|---|---|---|
| ndcg_at_5 | 0.878 | 0.648 | 0.230 | [0.093, 0.408] | 0.010 | 0.029 | 0.856 (cohens_dz) | 10 |
| hcsr | 1.000 | 0.500 | 0.500 | [0.380, 0.640] | 0.002 | 0.010 | 2.121 (cohens_dz) | 10 |
...
| mean_violation_count | 0.000 | 0.700 | -0.700 | [-1.080, -0.420] | 0.002 | 0.010 | -1.200 (cohens_dz) | 10 |
...
| metric | full | other | Δ | 95% CI | p | p(Holm) | effect | n |
|---|---|---|---|---|---|---|---|---|
| ndcg_at_5 | 0.911 | 0.738 | 0.173 | [0.112, 0.240] | 2.35e-05 | 7.04e-05 | 0.851 (cohens_dz) | 37 |
| hcsr | 0.984 | 0.708 | 0.276 | [0.205, 0.351] | 1.65e-06 | 8.25e-06 | 1.237 (cohens_dz) | 37 |
| task_success | 0.976 | 0.167 | 0.810 | [0.690, 0.929] | 1.16e-10 | 6.98e-10 | 1.000 (rank_biserial) | 42 |
| grounding | 1.000 | 1.000 | 0.000 | [0.000, 0.000] | 1.000 | 1.000 | 0.000 (rank_biserial) | 42 |
| mean_violation_count | 0.016 | 0.362 | -0.346 | [-0.486, -0.232] | 1.86e-06 | 8.25e-06 | -0.879 (cohens_dz) | 37 |
| turn_count | 1.500 | 1.500 | 0.000 | [0.000, 0.000] | 1.000 | 1.000 | 0.000 (rank_biserial) | 42 |

`task_success` is the **scenario-level binary** (repeats collapsed by majority vote, even-repeat ties → 0) in every column of its row, including the Δ and the CI. For reference, the mean success RATE over repeats is 0.976 (full) vs 0.167 (Δ 0.810); that is a different estimand and is not what the test above was computed on.
...
| preference_change | full | 0.820 | 0.950 | 0.917 | 1.000 | 2.17 | -2.17 | 12 |
| preference_change | profile_only | 0.686 | 0.680 | 0.167 | 1.000 | 2.17 | -586.08 | 12 |
| preference_change | one_shot | 0.747 | 0.733 | 0.167 | 1.000 | 2.17 | -752.92 | 12 |
| preference_change | no_memory | 0.747 | 0.733 | 0.167 | 1.000 | 2.17 | -752.92 | 12 |
...
|---|---|---|---|---|---|---|---|
| full vs profile_only | 42 | 84 | 1 | 42 | 34 | 42 | 1.16e-10 |
| full vs one_shot | 42 | 84 | 1 | 42 | 16 | 42 | 3.05e-05 |
| full vs no_memory | 42 | 84 | 1 | 42 | 9 | 42 | 0.004 |
| full vs no_context | 42 | 84 | 1 | 42 | 34 | 42 | 1.16e-10 |
...
Runs: 210; system failures: 0; task-unsuccessful runs: 98. Task failures by variant: full 1, no_context 35, no_memory 10, one_shot 17, profile_only 35.

Root-cause taxonomy of task-unsuccessful runs:

| error category | count | % | most-affected variant |
|---|---|---|---|
| missing_constraint_enforcement (ablation) | 35 | 35.7 | no_context |
| missing_dialogue_evidence (baseline) | 35 | 35.7 | profile_only |
| missing_dialogue_continuation (ablation) | 16 | 16.3 | one_shot |
| stale_or_missing_memory (ablation) | 9 | 9.2 | no_memory |
| other | 3 | 3.1 | full |

### 9.1 Representative case studies

### Case 1 — Memory helps (SC-D-01)
- **full ✓** [full repeat 0] — turns=['Data analyst in Kuala Lumpur, at least RM8000.', 'Actually 4000 is also fine.']; response=recommendation; active roles=['data analyst'], loc=['Kuala Lumpur'], salary_min=4000.0, hard=['salary_min']; top=[job-0136(g=3,s=0.754483); job-0128(g=3,s=0.750575); job-0088(g=3,s=0.74138)]
...
### Case 4 — Full failure (SC-D-02)
- **full ✗** [full repeat 0] — turns=['Business analyst in Penang, onsite only.', 'Hybrid is fine too, at least RM4000.']; response=recommendation; active roles=['business analyst'], loc=['Penang'], salary_min=4000.0, hard=['salary_min']; top=[job-0007(g=2,s=0.690722); job-0142(g=2,s=0.639176); job-0184(g=0,s=0.639175)]
